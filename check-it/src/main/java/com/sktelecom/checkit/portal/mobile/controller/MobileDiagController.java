package com.sktelecom.checkit.portal.mobile.controller;
...
public class MobileDiagController{
	private final static Log log = LogFactory.getLog(MobileDiagController.class);
