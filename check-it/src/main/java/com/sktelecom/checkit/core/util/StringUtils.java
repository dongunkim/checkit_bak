...
public class StringUtils { 
	...
	public static List stringToList(String sourceString, String delim) {
		...
		if (sourceString != null) {
			...
			destinationList.add(sourceString.substring(oldIndex, sourceString
					.length()));
		}
	...
	* 				num		: ���ڸ�����
	* 				format  : ġȯ����
	* ex>str : 1234567890123, num : 9, format : *
	...
	* @author 		������
	...
	private static final DecimalFormat defaultDecimalFormat = new DecimalFormat(
			"##############################");
	private static final int DEFAULT_PRECISION_FORMAT_LENGTH = ".00000000"
			.length();
	private static final DecimalFormat defaultPrecisionFormat = new DecimalFormat(
			".00000000");
	private static Map splitedArrs = Collections.synchronizedMap(new HashMap());
	private static Map splitedMap = Collections
