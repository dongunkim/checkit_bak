package com.sktelecom.checkit.core.property;
 ...
 * @author devkimsj
 */
public class PropertyServiceImpl implements PropertyService, InitializingBean, ResourceLoaderAware {
        ...
        try {
            ...
            while (it.hasNext()) {
                ...
                if (key == null || key.equals("")) {
                    throw new Exception("[ArisPropertyServiceImpl key is null]");
                }
    ...
    private void loadPropertyRes(Resource resource, String encoding)
            throws Exception {
        ExtendedProperties arisProperty = new ExtendedProperties();
        arisProperty.load(resource.getInputStream(), encoding);
        extendedProperties.combine(arisProperty);
    }
}