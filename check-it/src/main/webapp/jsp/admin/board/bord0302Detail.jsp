...
<div class="contens_bd" id="bord0302Form">
    <h2>고객 공지 조회</h2>
   	<div class="info_area">
        <h3>상세 내용</h3>
        <ul>
            <li>
                <span class="title">공지구분</span>
                <span class="word" id="bbsGb"  data-code=""></span>
            </li>
            <li>
   	            <span class="title">제목</span>
                <span class="word" id="bbsTitle"></span>
            </li>
            <li>
            	<div>
	                <span class="title">등록자</span>
	                <span class="word" id="regNm"></span>
            	</div>
            	<div>
             ...
             <li>
                ...
                <span class="word">
                	<div id="bord0302Fileupload" data-file-gbn="bbs"></div>
                </span>
            </li>      
            <li>
            	<span class="title">내용</span>
                <span class="word">
                	<span id="bbsDesc" name="bbsDesc"></span>
                </span>
            </li> 
        </ul>
    </div>
