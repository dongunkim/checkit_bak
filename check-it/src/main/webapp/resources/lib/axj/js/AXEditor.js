...
var AXEditor = Class.create(AXJ, {
    ...
    initialize: function (AXJ_super) {
        ...
        window.AXEditor_instances = window.AXEditor_instances || [];
        window.AXEditor_instances.push(this);
    ...
    initPanel: function () {
        ...
        if (config.toolbar.fontFamily)
        {
            ...
            po.push("	<a href='javascript:void(0);' class='me___value selectCommand me_ffs' style='font-family:" + config.editorFontFamily + "' id='" + this._GID([re, "fontname"]) + "'>" + config.editorFontFamily + "</a>");
            po.push("</div>");
        }
        if (config.toolbar.fontSize)
        {
            po.push("<div class='me___selectS'>");
            po.push("	<a href='javascript:void(0);' class='me___value selectCommand me_fss' id='" + this._GID([re, "fontsize"]) + "'>" + config.editorFontSize + "</a>");
            po.push("</div>");
        }
        ...
        if (config.toolbar.fontDecoration)
        {
            ...
            po.push("<a href='javascript:void(0);' class='me___btnL'>");
            po.push("	<span class='me_icon me___bold simpleCommand' id='" + this._GID([re, "bold"]) + "'>Bold</span>");
            po.push("</a>");

            po.push("<a href='javascript:void(0);' class='me___btnM'>");
            ...
            po.push("</a>");
            po.push("<a href='javascript:void(0);' class='me___btnR'>");
        ...
        if (config.toolbar.color)
        {
            ...
            po.push("	<a href='javascript:void(0);' class='me___value colorCommand' id='" + this._GID([re, "foreColor"]) + "'>foreColor</a>");
            po.push("	<a href='javascript:void(0);' class='me___arrow selectCommand me_picker' id='" + this._GID([re, "foreColorExt"]) + "'>+</a>");
            po.push("</div>");
            ...
            po.push("	<a href='javascript:void(0);' class='me___value colorCommand' id='" + this._GID([re, "backColor"]) + "'>backColor</a>");
            po.push("	<a href='javascript:void(0);' class='me___arrow selectCommand me_picker' id='" + this._GID([re, "backColorExt"]) + "'>+</a>");
            po.push("</div>");
        }
        ...
        {
            po.push("<div class='me___vline'></div>");
            po.push("<a href='javascript:void(0);' class='me___btnSa'>");
    ...
    openPanel: function () {
        ...
        if (this.panelNum == 1) {
            ...
            po.push("	<a href='javascript:void(0);' class='me___btnS1' id='" + this._GID([re, "attbtns", "insertDoc"]) + "'>" + lg.insertDoc + "</a>");
            po.push("	<a href='javascript:void(0);' class='me___btnS1' id='" + this._GID([re, "attbtns", "delete"]) + "'>" + lg.delSelected + "</a>");
            po.push("	<span class='me___span'>&nbsp;</span>");
            po.push("	<a href='javascript:void(0);' class='me___btnS1' id='" + this._GID([re, "attbtns", "selectAll"]) + "'>" + lg.selectAll + "</a>");
            po.push("</div>");
    ...
    initFoot: function () {
        ...
        po.push("	<a href='javascript:void(0);' id='" + config.targetID + "_contentMode_0' class='me____tab me____tabOn'>Editor</a>");
        po.push("	<a href='javascript:void(0);' id='" + config.targetID + "_contentMode_1' class='me____tab'>HTML</a>");
        po.push("</div>");
    ...
    lineHeightPicker: function (command) {
        ...
        this.lhPicker.css({width: 100, height: myHeight, left: 403, top: 25});
    ...
    urlPicker: function (command) {
        ...
        po.push("	<input type='radio' name='" + this._GID([re, command, "target"]) + "' id='" + target_blank + "' class='me_url' value='_blank'>");
        po.push("	<input type='radio' name='" + this._GID([re, command, "target"]) + "' id='" + target_self + "' class='me_url' value='_self' checked='checked'>");
        po.push("	<input type='button' value='OK' class='AXButtonSmall me_url me___inputBtnOK' />");
        po.push("	</div>");
        po.push("</div>");
        this.ulPicker = jQuery(po.join(''));
        var myHeight = 90;
        this.ulPicker.css({width: 300, height: myHeight, left: 235, top: 25});
    ...
    getContent: function () {
        ...
        if(utils.replaceAll(myEDT.body.innerHTML.replace("<br>", "").replace(/\n/g,"").replace("	", ""), " ", "") == ""){
        	return "";
        }else{
        	if (this.contentMode == "editor") {
